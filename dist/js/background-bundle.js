...
var _tab_history = __webpack_require__(45);

var _tab_history2 = _interopRequireDefault(_tab_history);

var _window_manager = __webpack_require__(49);
...
chrome.commands.onCommand.addListener(function (command) {
    ...
    if (command === 'show-tab-switcher') {
        ...
        Promise.all([currentWindow, switcherWindowId]).then(function (val) {
            var currentWindow = val[0];
            var switcherWindowId = val[1];
...
chrome.runtime.onMessage.addListener(function (request, sender, respond) {
    ...
    if (request.sendTabData) {
        Promise.all([history.getRecentTabs(), manager.getLastWindowId()]).then(function (val) {
            var recentTabs = val[0];
            var lastWindowId = val[1];
...
exports.default = function (chrome) {
  var recentTabs = null;
  ...
  return {
    ...
    getAllWindows: function getAllWindows() {
      ...
      var p = new Promise(function (resolve, reject) {
        chrome.windows.getAll(function (res) {
          resolve(res);
        });
      });
      return p;
    ...
    getRecentTabs: function getRecentTabs() {
      if (!recentTabs) {
        var storeData = this.getFromLocalStorage('lastTabs');
        ...
        */
        recentTabs = Promise.all([storeData, windows]).then(function (val) {
          var data = val[0];
          var windows = val[1];
          try {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(48), __webpack_require__(0)))
...
exports.default = function (chrome) {
  ...
  return {
    ...
    getCurrentWindow: function getCurrentWindow() {
      ...
      var p = new Promise(function (resolve, reject) {
        chrome.windows.getCurrent(function (res) {
          return resolve(res);
        });
      });
      return p;
    ...
    showSwitcher: function showSwitcher(width, height, left, top) {
      ...
      */
      var p = new Promise(function (resolve, reject) {
        chrome.windows.create(opts, function (res) {
          return resolve(res);
        });
      });
      p.then(function (val) {
        _this.setSwitcherWindowId(val.id);
      });
    ...
    queryTabs: function queryTabs(senderTabId, searchAllWindows, recentTabs, lastWindowId) {
      ...
      /*return util.pcall(chrome.tabs.query, options)
        ...
        */
      return new Promise(function (resolve, reject) {
        chrome.tabs.query(options, function (res) {
          return resolve(res);
        });
      }).then(function (val) {
        console.log("querytabs: ", val);
        var tabs = val.filter(function (tab) {
    ...
    closeTab: function closeTab(tabId) {
      ...
      var p = new Promise(function (resolve, reject) {
        chrome.tabs.remove(tabId, function (res) {
          return resolve(res);
        });
      });
